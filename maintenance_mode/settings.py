...
if not hasattr(settings, "MAINTENANCE_MODE_IGNORE_LOGOUT_SUPERUSER"):
    settings.MAINTENANCE_MODE_IGNORE_LOGOUT_SUPERUSER = False

if not hasattr(settings, "MAINTENANCE_MODE_IGNORE_LOGOUT_STAFF_USER"):
    settings.MAINTENANCE_MODE_IGNORE_LOGOUT_STAFF_USER = False
